...
try:
    # Add folder with the autogenerated files to the path.
    sys.path.append(os.path.join(os.path.dirname(os.path.abspath(__file__)), "autogen"))
    import autogen.plugin_pb2 as plugin_pb2
    import autogen.plugin_pb2_grpc as plugin_pb2_grpc
